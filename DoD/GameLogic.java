...
public class GameLogic{
	...
	public DoDPlayer getFromPlayers(int player){
		return players.get(player);
	}
	
	public void putPlayers(int player, DoDPlayer dodPlayer){
		players.put(player, dodPlayer);
	}
	...
	protected synchronized int[] getSpawnLocation(){
	...
	// Checks that the random spawn location which has been selected is not on a wall.
	@Test
	...
	protected synchronized boolean isAnotherPlayerOccupyingTile(int newX, int newY){
